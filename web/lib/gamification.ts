...
// A fonte oficial de dados de gamificação é o endpoint da API "/gamification/me" (backend).
// Esta curva local em `donorLevelBase` serve estritamente como um fallback/espelho visual para a interface.
